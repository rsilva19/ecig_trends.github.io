...
data_2011 = 
  list$`2011` %>% 
  select(year, "student_id" = StudntID, age = "qn1", sex = "qn2", 
         race = "race_s", cig_days = "qn13", try_ecigs = "qn36h",
         current_ecigs = "qn37h",  quit_cig = "qn54") %>%
...
data_2012 = 
  list$`2012` %>%
    select(year, StudntID, age = "qn1", sex = "qn2", race = "race_s", 
...
data_2015 = 
  list$`2015` %>%
    mutate(year = 2015) %>%
    select(year, STUDENT, age = "Qn1", sex = "Qn2", race = "RACE_S", 
           cig_days = "Qn12", try_ecigs = "Qn28", current_ecigs = "CELCIGT",
           harm_ecigs = "Qn37f", ecigs_past_month = "Qn32", age_first_ecig = "Qn31", 
...
data_2016 = 
  ...
  mutate(year = 2016, 
         student_id = c(1:nrow(.))) %>% 
  select(age = "Q1", sex = "Q2", race = "RACE_S", 
           cig_days = "Q13", try_ecigs = "Q26", current_ecigs = "Q31",
           harm_ecigs = "Q65", ecigs_past_month = "Q31", age_first_ecig = "Q30", 
           quit_cig = "Q59", reasons_ecigs = "Q36C", ads_ecigs = "Q73") %>%
  mutate(heard_ecigs = NA, 
         age = recode(age,
           ...
           ecigs_past_month = recode(ecigs_past_month, 
                                     ...
                                     "7" = "30"),
           age_first_ecig = recode(age_first_ecig, 
                                   "**" = "NA", "01" = "8 or younger", "02" = "8 or younger", "03" = "9",
...
# attempting to read in all columns - only wants to read in first 180
data_2016 = read_excel("./data/nyts2016.xlsx", 
                       range = "A1:FX20677") 

data_2016 = read_excel("./data/nyts2016.xlsx", 
                       range = cell_cols("A:FX"), 
                       col_types = 'text') 
data_2016 = data_2016 %>% filter(psu != "NA")
data_2016_part2 = read_excel("./data/nyts2016.xlsx", 
                       range = cell_cols("AY:FX"), 
                       col_types = 'text') 
```
