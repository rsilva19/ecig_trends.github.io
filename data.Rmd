...
Lastly, we briefly refer to the CDC's State Specific Patterns of E-Cigarette Use from 2016. This data provides the prevalence of current adult e-cigarette users in each state. The data has `r nrow(state_prev)` rows, for each state and the District of Columbia, and `r ncol(state_prev)` variables, for state name, the total prevalence, male prevalence, and female prevalence. 



Data sources: 

*[National Youth E-Cigarette Survey](./Data/ecig_data.csv)

*[Youth E-Cigarette Legislation ](./Data/legislation_data.csv)

*[State Specific E-Cigarette Prevalence](./Data/state_prev.csv)
