---
title: "Electronic Cigarettes Among Youth in the United States"
author: "Madison Stoms, Rebecca Silva, Robert Tumasian, and Charlotte Fowler"
...
## Related Work
As e-cigarettes were linked to cases of lung injury, many began criticizing suppliers, particularly because of their marketing towards teenagers. Companies such as JUUL were accused of social media campaigns and fruity flavors to attract younger users. Many have studied this phenomenon through surveys to understand the young users and their interest in e-cigarettes. Vallone et al conducted a nationally representative survey of participants aged 15-21 in 2018, and found that younger age, white race, higher socioeconomic status and perception that e-cigs are less harmful than cigarettes all correlated with a higher chance of using e-cigarettes [(2)](https://tobaccocontrol.bmj.com/content/28/6/603.abstract?casa_token=1PALiqs1TR0AAAAA:bwza2kpvUrDvqaHwd1Eb9lVT3WoYpW3Um5QgUNo_m1bOCA7Vk3KW_-4X7jWT8M-izEn2AxPJ8ekh). Similarly, Willet et al conducted an online survey to detect that in 2017, one fourth of youth and young adults recognized a JUUL device, and identified a lack of awareness of the potential harms of the tobacco in electronic cigarettes [(3)](https://tobaccocontrol.bmj.com/content/28/1/115.abstract?casa_token=jha9u61gODYAAAAA:zNkcmBbrIMpDW7jAoCGVb3L97MvluMMSOPN8tddPrPoZK91Nnrb-YdZ-tCqWm_88YbtKIB1rUifT). However, neither of these studies were able to analyze e-cigarette use across time. 


## Initial Questions

How has e-cigarette use among youth changed across time? Firstly, we wished to visualize and answer this question. While we know from outside sources that they have become more popular in across time, we hoped to demonstrate this curve and understand when and to what degree the change happened.  

Next, we asked: What factors put an individual more at risk of e-cigarette use? To answer this question, we consider demographics such as age, sex, and race, as well as cigarette consumption, perception towards the harm of e-cigarettes, and ads viewed for e-cigarettes. 

To differ from previous studies, we also wanted to consider the geographical dispersion of the epidemic, and attempts to reduce youth acccess to e-cigarettes. Therefore, we ask: How has legislation changed across time and space to address growing use of e-cigarettes in the United States? 



## Data
Our analysis was conducted using two data sources. The fist dataset is the National Youth Tobacco Use survey collected by the Center for Disease Control and Prevention [(4)](https://www.cdc.gov/tobacco/data_statistics/surveys/nyts/data/index.html). The raw data contains seperate surveys conducted in each year between 1999-2018. The surveys were given to 8-19 year olds across the country to address trends in tobacco use. To clean the data, we parsed each survey and identified questions pertaining to e-cigarette that were consistent among years. Since e-cigarette questions were not introduced until 2011, we restricted our analysis to years 2011-2018. Some questions of interest were not included in all years. To account for this, we assigned missing values to observation contained in the years in which the question was not addressed.
...
The second source is the CDC's State Tobacco Activities Tracking and Evaluation System [(5)](https://catalog.data.gov/dataset/cdc-state-system-e-cigarette-legislation-youth-access-a2edb). The data contain information on electronic cigarette legislation across the U.S. from 2011 to 2018.   
